...
DOCUMENT_ONLY_PROMPT = (
    "Письмо пришло без текста, только с приложенным документом. Коротко изложите суть документа."
)
RATE_LIMIT_NOTICE = (
...
SUMMARY_REPLY_HEADER = (
    "Сводка переписки этой сессии. Предыдущие сообщения в диалоге более не учитываются."
)
